...
<body>
  <div class="rectangle-parent">
    ...
    <b class="quattrocchi">Quattrocchi</b>
    ...
    <div class="rp20000">Rp.1.000.000</div>
    
    <!-- Form untuk submit dengan method POST -->
    <form action="process_payment.php" method="post">
      <a href="#" class="buy-now-wrapper">
        <!-- Tombol Submit -->
        <button type="submit" class="buy-now">Buy Now</button>
      </a>
    </form>
    
    <a href="#" class="chevron-wrapper">
      <img
    ...
    <a href="../portofolio(32)/frame-8.php" class="chevron-wrapper">
      <img
