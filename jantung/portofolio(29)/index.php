...
<body>
  <div class="rectangle-parent">
    ...
    <b class="trees-painting">Trees Painting</b>
    ...
    <div class="rp20000">Rp.600.000</div>
    ...
    <a href="../portofolio(30)/frame-8.php" class="chevron-right-fill0-wght400-gr-icon">
      <img
        alt=""
    ...
    <a href="../portofolio(28)/index.php" class="chevron-right-fill0-wght400-gr-icon1">
      <img
        alt=""
    ...
    <img class="img4-1-icon" alt="" src="./public/img4-1@2x.png" />
  </div>
</body>
</html>
