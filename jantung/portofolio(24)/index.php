...
<html>
  ...
  <body>
    <div class="rectangle-parent">
      ...
      <b class="serene-lake">Serene Lake</b>
      ...
      <div class="rp20000">Rp.100.000</div>
      <!-- Form untuk memproses pembayaran -->
      <form action="process_payment.php" method="post" class="buy-now-wrapper">
        <button type="submit" class="buy-now">Buy Now</button>
      </form>
      <a href="../portofolio(25)/index.php" class="chevron-right-fill0-wght400-gr-icon-parent">
        <img
      ...
      <a href="#" class="chevron-right-fill0-wght400-gr-icon1-parent">
        <img
      ...
      <img
        class="fca9c59778d6d1a045177d7f99613b-icon"
        alt=""
        src="./public/25fca9c59778d6d1a045177d7f99613b@2x.png"
      />
    </div>
  </body>
</html>
