...
<body>
  <div class="rectangle-parent">
    ...
    <div class="rp20000">Rp.500.000</div>
    ...
    <a href="../portofolio(29)/index.php" class="chevron-right-fill0-wght400-gr-icon">
      <img
        alt=""
    ...
    <a href="../portofolio(27)/index.php" class="chevron-right-fill0-wght400-gr-icon1">
      <img
        alt=""
    ...
    <img class="img3-1-icon" alt="" src="./public/img3-1@2x.png" />
  </div>
</body>
</html>
